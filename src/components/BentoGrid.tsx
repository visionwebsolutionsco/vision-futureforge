...
const DatabaseVisual = () => (
  <div className="absolute right-2 top-0 h-[300px] w-full scale-50 border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-75">
    <OrbitingSkills />
  </div>
);
